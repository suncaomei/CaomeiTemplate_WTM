        ...
        public void SetColumnFormat(ColumnDataType dateType, int porpetyIndex, ISheet sheet, ISheet dataSheet, ICellStyle dataStyle, IDataFormat dataFormat)
        {
            ...
            switch (dateType)
            {
                ...
                case ColumnDataType.Number:
                    ...
                    dataValidation.CreateErrorBox(CoreProgram._localizer?["Sys.Error"], CoreProgram._localizer?["Validate.PleaseInputNumber"]);
                    dataStyle.DataFormat = dataFormat.GetFormat("0");
                    dataValidation.CreatePromptBox(CoreProgram._localizer?["Validate.PleaseInputNumberFormat"], CoreProgram._localizer?["Sys.DataRange", MinValueOrLength, MaxValuseOrLength]);
                    break;
                ...
                case ColumnDataType.Float:
                    ...
                    dataValidation = (XSSFDataValidation)dvHelper.CreateValidation(dvConstraint, CellRangeList);
                    dataValidation.CreateErrorBox(CoreProgram._localizer?["Sys.Error"], CoreProgram._localizer?["Validate.PleaseInputDecimal"]);
                    dataStyle.DataFormat = HSSFDataFormat.GetBuiltinFormat("0.00");
                    dataValidation.CreatePromptBox(CoreProgram._localizer?["Validate.PleaseInputDecimalFormat"], CoreProgram._localizer?["Sys.DataRange", MinValueOrLength, MaxValuseOrLength]);
                    break;

                case ColumnDataType.Bool:
                    dvConstraint = (XSSFDataValidationConstraint)dvHelper.CreateFormulaListConstraint("Sheet1!$A$1:$B$1");
                    dataValidation = (XSSFDataValidation)dvHelper.CreateValidation(dvConstraint, CellRangeList);
                    dataValidation.CreateErrorBox(CoreProgram._localizer?["Sys.Error"], CoreProgram._localizer?["Validate.PleaseInputExistData"]);
                    dataValidation.CreatePromptBox(CoreProgram._localizer?["Sys.ComboBox"], CoreProgram._localizer?["Validate.PleaseInputExistData"]);
                    break;
                ...
                case ColumnDataType.Text:
                    ...
                    dataValidation.CreatePromptBox(CoreProgram._localizer?["Validate.PleaseInputText"], CoreProgram._localizer?["Sys.DataRange", MinValueOrLength, MaxValuseOrLength]);
                    break;
            ...
            else
            {
                ...
                switch (this.DataType)
                {
                    ...
                    case ColumnDataType.DateTime:
                        ...
                        {
                            err = new ErrorMessage { Index = rowIndex, Message = CoreProgram._localizer?["Validate.{0}formaterror", this.ColumnName] };
                        }
                    ...
                    case ColumnDataType.Enum:
                        ...
                        {
                            err = new ErrorMessage { Index = rowIndex, Message = CoreProgram._localizer?["Validate.{0}ValueNotExist", this.ColumnName] };
                        }
                        else
                        {
                    ...
                    default:
                        err = new ErrorMessage { Index = rowIndex, Message = CoreProgram._localizer?["Validate.{0}ValueTypeNotAllowed", this.ColumnName] };
                        break;
                }
