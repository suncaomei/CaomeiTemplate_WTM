...
namespace Caomei.Core.Extensions
{
    ...
    public static class TypeExtension
    {
        ...
        /// <summary> 判断是否为Nullable<>类型 </summary> <param name="self">Type类</param> <returns>判断结果</returns>
        public static bool IsNullable(this Type self)
        {
            return self.IsGeneric(typeof(Nullable<>));
        }

        /// <summary> 判断是否为List<>类型 </summary> <param name="self">Type类</param> <returns>判断结果</returns>
