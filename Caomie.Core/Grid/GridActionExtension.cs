...
namespace Caomei.Core
{
    ...
    public static class GridActionExtensions
    {
        ...
        /// <remarks> 根据标准动作类型，创建默认属性的标准动作 </remarks>
        ...
        /// button class. Some of the layui defined class to control color: layui-btn-primary
        /// layui-btn-normal layui-btn-warm layui-btn-danger
        /// </param>
        /// <returns> </returns>
