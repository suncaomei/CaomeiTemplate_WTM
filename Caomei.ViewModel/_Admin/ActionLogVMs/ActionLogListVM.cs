...
namespace WalkingTec.Mvvm.Mvc.Admin.ViewModels.ActionLogVMs
{
    public class ActionLogListVM : BasePagedListVM<ActionLog, ActionLogSearcher>
    {
        protected override List<GridAction> InitGridAction()
        {
            ...
            {
                this.MakeStandardAction("ActionLog", GridActionStandardTypesEnum.Details, "","Admin", dialogWidth: 800).SetHideOnToolBar(true),
                this.MakeStandardAction("ActionLog", GridActionStandardTypesEnum.ExportExcel, "","Admin"),
            };
            return actions;
        }
