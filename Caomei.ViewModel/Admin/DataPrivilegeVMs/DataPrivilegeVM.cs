    ...
    public class DataPrivilegeVM : BaseCRUDVM<DataPrivilege>
    {
        ...
        public override void Validate()
        {
            if (DpType == DpTypeEnum.User)
            {
                ...
                {
                    MSD.AddModelError("Entity.UserCode", Localizer["Validate.{0}required", Localizer["FrameworkUser.ITCode"]]);
                }
                else
                {
            ...
            else
            {
                ...
                {
                    MSD.AddModelError("Entity.GroupId", Localizer["Validate.{0}required", Localizer["FrameworkUser.Group"]]);
                }
            }
