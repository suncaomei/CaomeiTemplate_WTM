...
namespace Caomei.Mvc
{
    ...
    public class _FrameworkController : BaseController
    {
        ...
        public IActionResult UploadForLayUIRichTextBox([FromServices] WtmFileProvider fp, string _DONOT_USE_CS = "default", string groupName = null, string subdir = null)
        {
            ...
            {
                return Content($"{{\"code\": 1 , \"msg\": \"{Localizer["Sys.UploadFailed"]}\", \"data\": {{\"src\": \"\"}}}}");
            }
        }
        ...
        public IActionResult OutSide(string url)
        {
            ...
            else
            {
                if (menu.ParentId != null)
                {
                    ...
                    if (pmenu != null)
                    {
                        pmenu.PageName = CoreProgram._localizer?[pmenu.PageName];
...
<iframe src='{url}' frameborder='0' class='layadmin-iframe'></iframe>");
            ...
            {
                throw new Exception(Localizer["Sys.NoPrivilege"]);
            }
        }
        ...
        private void LocalizeMenu(List<Menu> menus)
        {
            ...
            foreach (var menu in menus)
            {
                ...
                menu.Title = CoreProgram._localizer?[menu.Title];
            }
        }
        ...
        public Dictionary<string, string> GetScriptLanguage()
        {
            ...
            rv.Add("DONOTUSE_Text_LoadFailed", Localizer["Sys.LoadFailed"]);
            rv.Add("DONOTUSE_Text_SubmitFailed", Localizer["Sys.SubmitFailed"]);
            rv.Add("DONOTUSE_Text_PleaseSelect", Localizer["Validate.PleaseSelect"]);
            rv.Add("DONOTUSE_Text_FailedLoadData", Localizer["Sys.FailedLoadData"]);
            return rv;
        }
