...
namespace Caomei.Mvc
{
    public static class MvcOptionExtension
    {
        public static void UseWtmMvcOptions(this MvcOptions options)
        {
            ...
            options.ModelBindingMessageProvider.SetValueIsInvalidAccessor((x) => CoreProgram._localizer?["Validate.{0}formaterror", x]);
            options.ModelBindingMessageProvider.SetAttemptedValueIsInvalidAccessor((x, y) => CoreProgram._localizer?["Validate.AttemptedValueIsInvalidAccessor", x, y]);
            options.ModelBindingMessageProvider.SetValueMustNotBeNullAccessor((x) => CoreProgram._localizer?["Validate.{0}formaterror", x]);
