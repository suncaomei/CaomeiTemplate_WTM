    ...
    public class PrivilegeFilter : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            if (controller.Wtm.ConfigInfo.IsFilePublic == true)
            {
                ...
                if (ad.ControllerTypeInfo.FullName == "Caomei.Admin.Controllers.FileApiController" && (ad.MethodInfo.Name == "GetFileName" || ad.MethodInfo.Name == "GetFile" || ad.MethodInfo.Name == "DownloadFile"))
                {
                    isPublic = true;
                }
            }
